...
protected:
    ...
    struct DroneRecord {
		...
		void printRecord(){
			cout << "Drone ID: " << droneID << " | Range: " << range << " | Year Bought: " << yearBought << " | Drone Type: " << droneType << " | Manufacturer: " << manufacturer << " | Description: " << description << " | Battery Type: " << batteryType << endl;
